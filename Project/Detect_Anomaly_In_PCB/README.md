...
to_v5_directories("dataset/images/train", "dataset/images/val", "dataset/labels/train", "dataset/labels/val", "Annotations_xml\Missing_hole") # Replace all the parameters with the right folder paths 
```
